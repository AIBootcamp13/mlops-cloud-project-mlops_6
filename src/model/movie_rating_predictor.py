...
from src.dataset.movie_rating import MovieRatingDataset
...
class MovieRatingPredictor:
    ...
    def save_model(self, model_params, epoch, loss, scaler, label_encoders, mlb_genres, mlb_keywords):
        ...
        save_data = {
            ...
            "mlb_genres": mlb_genres,  # 장르 인코더 추가
            "mlb_keywords": mlb_keywords,  # 키워드 인코더 추가
        }
